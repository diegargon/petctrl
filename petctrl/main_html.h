...
<p><a href="/settings">Configuración</a></p>
  <center>
  <table><tr>
  <td> <!-- <img width=\"256\" heigh=\"256\" src=foto.jpg /> --> </td>
  <td>
...
<center>
<p>Foto:</p>
<p><!-- <img width=\"256\" heigh=\"256\" src=foto.jpg /> --></p>
<br>
...
<tr><th><p align="right">Habilitar:</p></th><th>
<input type="checkbox" *sta state* name="APEnable" value="1" />
</th></tr>
...
<tr><th><p align="right">Contraseña administración:</p></th><th><input maxlength="30" type="text" name="LoginKey" value="*LoginKey*"></th></tr>
